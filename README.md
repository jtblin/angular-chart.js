...
[![code coverage](https://codecov.io/gh/jtblin/angular-chart.js/graph/badge.svg)](https://app.codecov.io/gh/jtblin/angular-chart.js)
...
This is the `3.x` branch which requires **Chart.js 4.x** and **AngularJS 1.8.x**.
